...
# HW#2: CMAC
# Author: Akshitha Pothamshetty(116399326)
...
# Gen 1
plt.figure(1)
plt.plot(new_test_num, w_new_array, '-b', label="Testing Curve (gen = 5)")
plt.plot(new_test_num, w_new_array2, '-g', label="Testing Curve (gen = 9)")
plt.plot(new_test_num, w_new_array3, '-r', label="Testing Curve (gen = 13)")
